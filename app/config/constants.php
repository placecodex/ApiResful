...
define('DBPASSWORD','');
define('DBNAME', 'techarise_DB');
                           
// windows path
define('BASH_PATH', 'C:/laragon/www/codeigniter-crop-image/');
// ubuntu path
//define('BASH_PATH', 'var/www/codeigniter-crop-image/');
// MAC path
#define('BASH_PATH', 'C:/laragon/www/htdocs/codeigniter-crop-image/');
...
define('HTTP_CROP_PATH', $constants['base_url'] . 'assets/crop/');
