...
|
*/
$config['rest_database_group'] = 'pdo_mysqli';
...
|
*/
$config['rest_enable_keys'] = FALSE; // API KEY AUTHENTIFICATION
...
|
*/
$config['rest_logs_table'] = 'logs_api_rest';
...
'http://3pago.test', 'https://http://api.3pago.test'
